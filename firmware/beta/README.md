...
you may instead do:  
    ...
    cd /tmp  
    wget http://pegol.tackin.de/firmware/beta/sysupgrade/gluon-fftr-0.11.4+tackin.....sysupgrade.bin
 
or  

    cd /tmp  
    wget http://2.updates.services.fftr/firmware/beta/sysupgrade/gluon-fftr-0.11.4+tackin.....sysupgrade.bin  
(please add the right file for your node-type and node-version)

    echo 3 > /proc/sys/vm/drop_caches  
    sysupgrade gluon-fftr-0.11.4+tackin....sysupgrade.bin  
